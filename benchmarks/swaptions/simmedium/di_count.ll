...
; <label>:86                                      ; preds = %81
  ...
  call void @profileCount(i64 937)
...
define void @_Z7nrerrorPKc(i8* %error_text) #3 {
  ...
  call void @profileCount(i64 3461)
  %4 = load %struct._IO_FILE** @stderr, align 8, !llfi_index !3461
  call void @profileCount(i64 3462)
  %5 = load i8** %1, align 8, !llfi_index !3462
  call void @profileCount(i64 3463)
  ...
  call void @profileCount(i64 3464)
  %7 = load %struct._IO_FILE** @stderr, align 8, !llfi_index !3464
  call void @profileCount(i64 3465)

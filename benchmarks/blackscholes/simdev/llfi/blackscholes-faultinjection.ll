; ModuleID = '/home/foo/edc-predictor/benchmarks/blackscholes/simdev/llfi/blackscholes-llfi_index.ll'
...
define float @CNDF(float %InputX) #0 {
  ...
  %fi11 = call i32* @injectFault2(i64 2, i32* %sign, i32 26, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([7 x i8]* @alloca_namestr, i32 0, i32 0)), !llfi_injectfault !2
  %OutputX = alloca float, align 4, !llfi_index !4
  %fi12 = call float* @injectFault0(i64 3, float* %OutputX, i32 26, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([7 x i8]* @alloca_namestr, i32 0, i32 0)), !llfi_injectfault !2
  %xInput = alloca float, align 4, !llfi_index !5
  %fi13 = call float* @injectFault0(i64 4, float* %xInput, i32 26, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([7 x i8]* @alloca_namestr, i32 0, i32 0)), !llfi_injectfault !2
  %xNPrimeofX = alloca float, align 4, !llfi_index !6
  %fi14 = call float* @injectFault0(i64 5, float* %xNPrimeofX, i32 26, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([7 x i8]* @alloca_namestr, i32 0, i32 0)), !llfi_injectfault !2
  %expValues = alloca float, align 4, !llfi_index !7
  %fi15 = call float* @injectFault0(i64 6, float* %expValues, i32 26, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([7 x i8]* @alloca_namestr, i32 0, i32 0)), !llfi_injectfault !2
  %xK2 = alloca float, align 4, !llfi_index !8
  %fi16 = call float* @injectFault0(i64 7, float* %xK2, i32 26, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([7 x i8]* @alloca_namestr, i32 0, i32 0)), !llfi_injectfault !2
  %xK2_2 = alloca float, align 4, !llfi_index !9
  %fi17 = call float* @injectFault0(i64 8, float* %xK2_2, i32 26, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([7 x i8]* @alloca_namestr, i32 0, i32 0)), !llfi_injectfault !2
  %xK2_3 = alloca float, align 4, !llfi_index !10
  %fi18 = call float* @injectFault0(i64 9, float* %xK2_3, i32 26, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([7 x i8]* @alloca_namestr, i32 0, i32 0)), !llfi_injectfault !2
  %xK2_4 = alloca float, align 4, !llfi_index !11
  %fi19 = call float* @injectFault0(i64 10, float* %xK2_4, i32 26, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([7 x i8]* @alloca_namestr, i32 0, i32 0)), !llfi_injectfault !2
  %xK2_5 = alloca float, align 4, !llfi_index !12
  %fi20 = call float* @injectFault0(i64 11, float* %xK2_5, i32 26, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([7 x i8]* @alloca_namestr, i32 0, i32 0)), !llfi_injectfault !2
  %xLocal = alloca float, align 4, !llfi_index !13
  %fi21 = call float* @injectFault0(i64 12, float* %xLocal, i32 26, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([7 x i8]* @alloca_namestr, i32 0, i32 0)), !llfi_injectfault !2
  %xLocal_1 = alloca float, align 4, !llfi_index !14
  %fi22 = call float* @injectFault0(i64 13, float* %xLocal_1, i32 26, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([7 x i8]* @alloca_namestr, i32 0, i32 0)), !llfi_injectfault !2
  ...
  %fi23 = call float* @injectFault0(i64 15, float* %xLocal_3, i32 26, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([7 x i8]* @alloca_namestr, i32 0, i32 0)), !llfi_injectfault !2
  store float %InputX, float* %fi1, align 4, !llfi_index !17
  %2 = load float* %fi1, align 4, !llfi_index !18
  %fi24 = call float @injectFault1(i64 17, float %2, i32 27, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !2
  %3 = fpext float %fi24 to double, !llfi_index !19
  %fi25 = call double @injectFault3(i64 18, double %3, i32 41, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([6 x i8]* @fpext_namestr, i32 0, i32 0)), !llfi_injectfault !2
  %4 = fcmp olt double %fi25, 0.000000e+00, !llfi_index !20
  %fi26 = call i1 @injectFault4(i64 19, i1 %4, i32 47, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @fcmp_namestr, i32 0, i32 0)), !llfi_injectfault !2
  br i1 %fi26, label %5, label %8, !llfi_index !21

; <label>:5                                       ; preds = %0
  %6 = load float* %fi1, align 4, !llfi_index !22
  %fi27 = call float @injectFault1(i64 21, float %6, i32 27, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !2
  %7 = fsub float -0.000000e+00, %fi27, !llfi_index !23
  %fi28 = call float @injectFault1(i64 22, float %7, i32 11, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @fsub_namestr, i32 0, i32 0)), !llfi_injectfault !2
  store float %fi28, float* %fi1, align 4, !llfi_index !24
  store i32 1, i32* %fi11, align 4, !llfi_index !25
  br label %9, !llfi_index !26

; <label>:8                                       ; preds = %0
  store i32 0, i32* %fi11, align 4, !llfi_index !27
  br label %9, !llfi_index !28

; <label>:9                                       ; preds = %8, %5
  %10 = load float* %fi1, align 4, !llfi_index !29
  %fi30 = call float @injectFault1(i64 28, float %10, i32 27, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !2
  store float %fi30, float* %fi13, align 4, !llfi_index !30
  %11 = load float* %fi1, align 4, !llfi_index !31
  %fi31 = call float @injectFault1(i64 30, float %11, i32 27, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !2
  %12 = fmul float -5.000000e-01, %fi31, !llfi_index !32
  %fi32 = call float @injectFault1(i64 31, float %12, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !2
  %13 = load float* %fi1, align 4, !llfi_index !33
  %fi33 = call float @injectFault1(i64 32, float %13, i32 27, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !2
  %14 = fmul float %fi32, %fi33, !llfi_index !34
  %fi34 = call float @injectFault1(i64 33, float %14, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !2
  %15 = fpext float %fi34 to double, !llfi_index !35
  %fi35 = call double @injectFault3(i64 34, double %15, i32 41, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([6 x i8]* @fpext_namestr, i32 0, i32 0)), !llfi_injectfault !2
  %16 = call double @exp(double %fi35) #5, !llfi_index !36
  %fi36 = call double @injectFault3(i64 35, double %16, i32 49, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @call_namestr, i32 0, i32 0)), !llfi_injectfault !2
  %17 = fptrunc double %fi36 to float, !llfi_index !37
  %fi29 = call float @injectFault1(i64 36, float %17, i32 40, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([8 x i8]* @fptrunc_namestr, i32 0, i32 0)), !llfi_injectfault !2
  store float %fi29, float* %fi15, align 4, !llfi_index !38
  %18 = load float* %fi15, align 4, !llfi_index !39
  %fi38 = call float @injectFault1(i64 38, float %18, i32 27, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !2
  store float %fi38, float* %fi14, align 4, !llfi_index !40
  %19 = load float* %fi14, align 4, !llfi_index !41
  %fi39 = call float @injectFault1(i64 40, float %19, i32 27, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !2
  %20 = fpext float %fi39 to double, !llfi_index !42
  %fi40 = call double @injectFault3(i64 41, double %20, i32 41, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([6 x i8]* @fpext_namestr, i32 0, i32 0)), !llfi_injectfault !2
  %21 = fmul double %fi40, 0x3FD9884533D43651, !llfi_index !43
  %fi41 = call double @injectFault3(i64 42, double %21, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !2
  %22 = fptrunc double %fi41 to float, !llfi_index !44
  %fi42 = call float @injectFault1(i64 43, float %22, i32 40, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([8 x i8]* @fptrunc_namestr, i32 0, i32 0)), !llfi_injectfault !2
  store float %fi42, float* %fi14, align 4, !llfi_index !45
  %23 = load float* %fi13, align 4, !llfi_index !46
  %fi43 = call float @injectFault1(i64 45, float %23, i32 27, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !2
  %24 = fpext float %fi43 to double, !llfi_index !47
  %fi44 = call double @injectFault3(i64 46, double %24, i32 41, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([6 x i8]* @fpext_namestr, i32 0, i32 0)), !llfi_injectfault !2
  %25 = fmul double 2.316419e-01, %fi44, !llfi_index !48
  %fi45 = call double @injectFault3(i64 47, double %25, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !2
  %26 = fptrunc double %fi45 to float, !llfi_index !49
  %fi46 = call float @injectFault1(i64 48, float %26, i32 40, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([8 x i8]* @fptrunc_namestr, i32 0, i32 0)), !llfi_injectfault !2
  store float %fi46, float* %fi16, align 4, !llfi_index !50
  %27 = load float* %fi16, align 4, !llfi_index !51
  %fi60 = call float @injectFault1(i64 50, float %27, i32 27, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !2
  %28 = fpext float %fi60 to double, !llfi_index !52
  %fi61 = call double @injectFault3(i64 51, double %28, i32 41, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([6 x i8]* @fpext_namestr, i32 0, i32 0)), !llfi_injectfault !2
  %29 = fadd double 1.000000e+00, %fi61, !llfi_index !53
  %fi62 = call double @injectFault3(i64 52, double %29, i32 9, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @fadd_namestr, i32 0, i32 0)), !llfi_injectfault !2
  %30 = fptrunc double %fi62 to float, !llfi_index !54
  %fi63 = call float @injectFault1(i64 53, float %30, i32 40, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([8 x i8]* @fptrunc_namestr, i32 0, i32 0)), !llfi_injectfault !2
  store float %fi63, float* %fi16, align 4, !llfi_index !55
  %31 = load float* %fi16, align 4, !llfi_index !56
  %fi64 = call float @injectFault1(i64 55, float %31, i32 27, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !2
  %32 = fpext float %fi64 to double, !llfi_index !57
  %fi65 = call double @injectFault3(i64 56, double %32, i32 41, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([6 x i8]* @fpext_namestr, i32 0, i32 0)), !llfi_injectfault !2
  %33 = fdiv double 1.000000e+00, %fi65, !llfi_index !58
  %fi37 = call double @injectFault3(i64 57, double %33, i32 16, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @fdiv_namestr, i32 0, i32 0)), !llfi_injectfault !2
  %34 = fptrunc double %fi37 to float, !llfi_index !59
  %fi66 = call float @injectFault1(i64 58, float %34, i32 40, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([8 x i8]* @fptrunc_namestr, i32 0, i32 0)), !llfi_injectfault !2
  store float %fi66, float* %fi16, align 4, !llfi_index !60
  %35 = load float* %fi16, align 4, !llfi_index !61
  %fi4 = call float @injectFault1(i64 60, float %35, i32 27, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !2
  %36 = load float* %fi16, align 4, !llfi_index !62
  %fi5 = call float @injectFault1(i64 61, float %36, i32 27, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !2
  %37 = fmul float %fi4, %fi5, !llfi_index !63
  %fi6 = call float @injectFault1(i64 62, float %37, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !2
  store float %fi6, float* %fi17, align 4, !llfi_index !64
  %38 = load float* %fi17, align 4, !llfi_index !65
  %fi7 = call float @injectFault1(i64 64, float %38, i32 27, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !2
  %39 = load float* %fi16, align 4, !llfi_index !66
  %fi8 = call float @injectFault1(i64 65, float %39, i32 27, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !2
  %40 = fmul float %fi7, %fi8, !llfi_index !67
  %fi9 = call float @injectFault1(i64 66, float %40, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !2
  store float %fi9, float* %fi18, align 4, !llfi_index !68
  %41 = load float* %fi18, align 4, !llfi_index !69
  %fi10 = call float @injectFault1(i64 68, float %41, i32 27, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !2
  %42 = load float* %fi16, align 4, !llfi_index !70
  ...
  %43 = fmul float %fi10, %fi67, !llfi_index !71
  ...
  store float %fi68, float* %fi19, align 4, !llfi_index !72
  %44 = load float* %fi19, align 4, !llfi_index !73
  ...
  %45 = load float* %fi16, align 4, !llfi_index !74
  ...
  store float %fi71, float* %fi20, align 4, !llfi_index !76
  %47 = load float* %fi16, align 4, !llfi_index !77
  ...
  store float %fi75, float* %fi22, align 4, !llfi_index !81
  %51 = load float* %fi17, align 4, !llfi_index !82
  ...
  %55 = load float* %fi18, align 4, !llfi_index !87
  ...
  store float %fi83, float* %fi23, align 4, !llfi_index !91
  ...
  %60 = load float* %fi23, align 4, !llfi_index !93
  ...
  %62 = load float* %fi19, align 4, !llfi_index !96
  ...
  %fi47 = call double @injectFault3(i64 97, double %64, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !2
  %65 = fptrunc double %fi47 to float, !llfi_index !99
  ...
  store float %fi2, float* %fi23, align 4, !llfi_index !100
  ...
  %67 = load float* %fi23, align 4, !llfi_index !102
  %fi48 = call float @injectFault1(i64 101, float %67, i32 27, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !2
  %68 = fadd float %fi3, %fi48, !llfi_index !103
  %fi49 = call float @injectFault1(i64 102, float %68, i32 9, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @fadd_namestr, i32 0, i32 0)), !llfi_injectfault !2
  store float %fi49, float* %fi, align 4, !llfi_index !104
  %69 = load float* %fi20, align 4, !llfi_index !105
  %fi50 = call float @injectFault1(i64 104, float %69, i32 27, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !2
  %70 = fpext float %fi50 to double, !llfi_index !106
  %fi51 = call double @injectFault3(i64 105, double %70, i32 41, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([6 x i8]* @fpext_namestr, i32 0, i32 0)), !llfi_injectfault !2
  %71 = fmul double %fi51, 0x3FF548CDD6F42943, !llfi_index !107
  %fi52 = call double @injectFault3(i64 106, double %71, i32 13, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !2
  %72 = fptrunc double %fi52 to float, !llfi_index !108
  %fi53 = call float @injectFault1(i64 107, float %72, i32 40, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([8 x i8]* @fptrunc_namestr, i32 0, i32 0)), !llfi_injectfault !2
  store float %fi53, float* %fi23, align 4, !llfi_index !109
  %73 = load float* %fi, align 4, !llfi_index !110
  %fi54 = call float @injectFault1(i64 109, float %73, i32 27, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !2
  %74 = load float* %fi23, align 4, !llfi_index !111
  %fi55 = call float @injectFault1(i64 110, float %74, i32 27, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !2
  %75 = fadd float %fi54, %fi55, !llfi_index !112
  %fi56 = call float @injectFault1(i64 111, float %75, i32 9, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @fadd_namestr, i32 0, i32 0)), !llfi_injectfault !2
  store float %fi56, float* %fi, align 4, !llfi_index !113
  %76 = load float* %fi, align 4, !llfi_index !114
  %fi57 = call float @injectFault1(i64 113, float %76, i32 27, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !2
  %77 = load float* %fi22, align 4, !llfi_index !115
  %fi58 = call float @injectFault1(i64 114, float %77, i32 27, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !2
  %78 = fadd float %fi57, %fi58, !llfi_index !116
  %fi59 = call float @injectFault1(i64 115, float %78, i32 9, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8]* @fadd_namestr, i32 0, i32 0)), !llfi_injectfault !2
  store float %fi59, float* %fi22, align 4, !llfi_index !117
  %79 = load float* %fi22, align 4, !llfi_index !118
  ...
  %80 = load float* %fi14, align 4, !llfi_index !119
  ...
  store float %fi91, float* %fi21, align 4, !llfi_index !121
  %82 = load float* %fi21, align 4, !llfi_index !122
  ...
  store float %fi95, float* %fi21, align 4, !llfi_index !126
  %86 = load float* %fi21, align 4, !llfi_index !127
  ...
  store float %fi96, float* %fi12, align 4, !llfi_index !128
  %87 = load i32* %fi11, align 4, !llfi_index !129
...
; <label>:89                                      ; preds = %9
  %90 = load float* %fi12, align 4, !llfi_index !132
  ...
  store float %fi102, float* %fi12, align 4, !llfi_index !136
  br label %94, !llfi_index !137

; <label>:94                                      ; preds = %89, %9
  %95 = load float* %fi12, align 4, !llfi_index !138
